function createWidget(positionId, config) {
    ...
    if (typeof options.params !== 'undefined') {
        options.widget_url += "&"+$.param(options.params)
    }
    ...
    Widget = {
        ...
        show: function() {
            ...
            this.widgetElement.innerHTML = ' \
                <iframe id="widget_iframe' + options.id + '" src="' + options.widget_url + '" scrolling="no" width="100%" height="175" frameborder="0"></iframe>';
